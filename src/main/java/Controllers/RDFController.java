...
public class RDFController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("RDFFile", content);
        request.getRequestDispatcher("RDFView.jsp").forward(request, response);
        //returneaza structura RDF sa o poata vedea beleaua de view idk how tho
    }
